...
status.register("text",
    text="New Comic",
    cmd_leftclick="/home/ibrahim/.i3/update_background",
    color="#44bbff")
...
i3lock = "i3lock -i /home/ibrahim/Pictures/Wallpaper/background.jpg -p win";
